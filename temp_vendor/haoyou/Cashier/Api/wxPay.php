...
class wxPay {
    //配置参数信息
    // const APPID = "wxfebacb6c401a6773";//商户号
    // const MCHID = "1483718032";    //api，商户后台
    // const APPSECRET = "fadb5b7163f55cdfbdbb67fedd138176";    //api，商户后台
    ...
    function pay($url,$obj,$key = '') {
        ...
        if($key){
            ...
            $stringSignTemp = $stringA."&key=".WxPayConfig::KEY;    //签名后加api
        }
